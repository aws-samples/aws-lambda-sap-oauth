...
public class KeyStoreHandler {
	...
	public static Map<String,Object> getKeys(Properties props) throws IOException, KeyStoreException, NoSuchAlgorithmException, CertificateException, UnrecoverableKeyException {
